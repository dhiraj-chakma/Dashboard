...
export const EditorData = () => (
  <div>
    <p>
      In a lively corner of the digital world, there lived Dhiraj, known among
      his friends for a rather fun trick: he could mimic anyone’s voice. Whether
      it was copying how his buddies chatted or imagining how they'd react in
      wacky scenarios, Dhiraj had a knack for it. This talent turned many
      ordinary days into laugh fests, making him quite the entertainer in his
      circle.
    </p>
    <p>
      Dhiraj had an adventure in a sunny place called Sabadell in Barcelona, a
      spot where the sun seemed to hug the hills just right, and where everyone
      greeted you with a smile. This place was like a slice of peace, with its
      cozy cafes and friendly faces. But it was also where he went through a
      tough breakup, making his memories there as mixed as a sunset's colors.
    </p>
    <p>
      {" "}
      In his coding world,Dhiraj wished for something a bit magical: to never
      make mistakes in his work. It seemed like every time he thought he’d fixed
      everything, a new bug would pop up, as if saying, "Try again!" This dream
      of coding without hiccups was like hoping for a never-ending sunny day in
      programmer’s land.
    </p>
    <p>
      Despite loving his phone for keeping him connected and entertained, Dhiraj
      sometimes felt the need to just put it away and enjoy some quiet. He
      believed in something pretty cool: doing what you love, no matter what. To
      him, coding wasn’t just a job; it was what made him jump out of bed every
      day, eager to create, whether or not it was perfect or if anyone else got
      it. This joy in just doing was Dhiraj's secret to a happy life.
    </p>
  </div>
);
